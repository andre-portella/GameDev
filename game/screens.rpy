...
# Calcular a altura máxima do botão
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        frame:
            ...
            hbox:
                style_prefix "quick"
                xalign 0.5  # Centraliza o hbox no frame
...
style quick_button:
    ...
    background "#444444"  # Fundo cinza escuro para os botões

style quick_button_text:
    properties gui.text_properties("quick_button")

## Define o fundo escuro para o quick_menu e expande a largura
style quick_frame:
    background "#00000080"  # Fundo preto com 50% de transparência
    xfill True  # Preenche horizontalmente    
